...
you should place your code here."
  ...
  (key-chord-mode 1)
  (key-chord-define evil-insert-state-map ";;" 'user-end-line-quit)
  (key-chord-define evil-insert-state-map "ll" 'user-move-right)
